...
if __name__ == "__main__":
    ...
    # src_image = cv2.fastNlMeansDenoising(binary_image, None)
    # x.save_picture(src_image, "2")
    # finanl = x.dynamic_kernel_morphology(src_image)
    # x.save_picture(finanl, "3")
   
    # if src_image is None:
    #     print("Failed to load image. Check the file path.")
    # else:
        # result = x.decode_ecc200(src_image, timeout_ms=6000)
    # result = x.simple_decode_dmtx(finanl, timeout_ms=6000)
